...
parser.add_argument('--env', type=str, default ="toyatlasgan"   ,  help='visdom environment')
...
for epoch in range(opt.nepoch):
	...
	for i, data in enumerate(dataloader, 0):
		...
		pointsReconstructed1  = network1.forward_inference_gan(points) #forward pass
		pointsReconstructed2  = network2.forward_inference_gan(points) #forward pass
		pointsReconstructed3  = network3.forward_inference_gan(points) #forward pass
